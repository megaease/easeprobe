...
type Settings struct {
	...
	PIDFile    string     `yaml:"pid" json:"pid,omitempty" jsonschema:"title=PID File,description=The PID file of the EaseProbe instance (leave this empty means no PID file)"`
